...
export function KPICardSkeleton() {
  return (
    <div className="bg-white rounded-2xl shadow-soft border border-black/[0.03] p-5 animate-pulse">
...
export function TableRowSkeleton({ rows = 5 }: { rows?: number }) {
  return (
    <div className="bg-white rounded-2xl shadow-soft border border-black/[0.03] p-5 animate-pulse space-y-3">
      <div className="h-3 w-32 bg-eco-surface-2 rounded mb-4" />
